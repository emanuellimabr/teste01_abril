...
class ClienteController extends Controller
{
    ...
    {
        return view('cliente.createOrUpdate');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('cliente.index')->with('message', 'Cliente adicionado com sucesso!!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('cliente.createOrUpdate', compact('cliente'));
    }
